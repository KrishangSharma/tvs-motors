import type { ServiceConfirmationEmailProps } from "@/types";
import {
  Body,
  Container,
  Head,
...
export const AdminServiceConfirmationEmail = ({
  name = "John Doe",
  ...
  return (
    <Html>
      <Head />
      <Preview>New Vehicle Service Booking - {referenceNumber}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              A new vehicle service booking has been submitted with the
              following details:
            </Text>
            ...
            <Section style={actionSection}>
              ...
              <Section style={buttonContainer}>
                <Button
                  href={`https://admin.tvsmotor.com/service/${referenceNumber}`}
                  style={primaryButton}
                >
                  View Service Details
                </Button>
                <Button
                  href={`https://admin.tvsmotor.com/service/${referenceNumber}/assign`}
...
export default AdminServiceConfirmationEmail;
