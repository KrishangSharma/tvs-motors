...
export const contactInfo = [
  { title: "CONTACT", icon: Phone, content: "+91 8588869151" },
  { title: "EMAIL", icon: Mail, content: "customercare@sabharwaltvs.com" },
];
...
export const socialLinks = [
  ...
  // },
  {
    href: "https://www.facebook.com/sabharwalautomobiles",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    href: "https://www.instagram.com/sabharwaltvs/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
