...
// Data for Desktop and Mobile Footer sections
...
export default function Footer() {
  return (
    <footer className="bg-customBlue text-white font-nunito">
      {/* Desktop Footer */}
      <div className=" px-5 py-8 hidden md:block">
        <div className="mb-8">
          <Image
            src={Logo}
            alt="TVS Logo"
      ...
      <div className="md:hidden">
        ...
        {/* TVS Connect App Mobile */}
        <div className="px-4 py-6 text-center border-t border-[#1a3c8d]">
          <h3 className="font-bold mb-4">TVS CONNECT APP</h3>
          <div className="flex justify-center space-x-2">
            {desktopFooterSections
              .find((section) => section.title === "SHOP")
              ?.extra?.[0].items.map((item, idx) => (
                <Link key={idx} href={item.href} className="inline-block">
                  <Image
                    src={item.image}
                    alt={item.alt}
        ...
        <div className="px-4 py-4 border-t border-[#1a3c8d]">
          <h3 className="font-bold mb-4 text-center">CONTACT</h3>
        ...
        <div className="px-4 py-4 border-t border-[#1a3c8d]">
          <h3 className="font-bold mb-4 text-center">EMAIL</h3>
          <div className="flex items-center justify-center mb-2">
            <Mail className="w-4 h-4 mr-2" />
            <span>customercare@tvsmotor.com</span>
          </div>
        </div>

        {/* Road Assistance Mobile */}
        <div className="px-4 py-4 border-t border-[#1a3c8d]">
          ...
          <div className="flex items-center justify-center mb-2">
            ...
            <span>Dial 1800-258-7111 and Press "1"</span>
          </div>
        </div>

        {/* Social Media Mobile */}
        <div className="px-4 py-4 border-t border-[#1a3c8d] text-center">
